...
const realisasiPenggunaan = () => {
  ...
  const [dataFilter, setDataFilter] = useState([
    ...
    {
      kode: "24",
      kanwil: "Kantor Wilayah Provinsi Nusa Tenggara Timur",
    },
  ]);
        ...
        <div className={classes.paper}>
            ...
            >
              <CopyToClipboard
                text={
                  ...
                  BASE_URL.domain +
                  "/embed/" +
                  BASE_URL.path.realisasi_penggunaan +
                  '"></iframe>'
                }
          ...
          >
            <iframe
              ...
              height={iframeHeight}
              src={
                BASE_URL.domain + "/embed/" + BASE_URL.path.realisasi_penggunaan
              }
            ></iframe>
          </Grid>
        </div>
