...
const RealisasiTargetPenerimaan = () => {
  ...
  const getData = () => {
    ...
    axios
      .get(`${url}Aset&Keuangan/PNBP/sie_pnbp_target_penerimaan`)
  ...
  const exportData = () => {
    fileExport(
      ...
      "penerimaan berbanding PNBP penerimaan dan belanja per bulan",
      data,
      ".xlsx"
    );
  };
  ...
  const title = "Penerimaan berbanding PNBP penerimaan dan belanja per bulan";
  const handlePrint = () => {
    history.push({
      pathname: "/PrintData",
      state: {
            ...
            >
              <CopyToClipboard
                text={
                  ...
                  BASE_URL.domain +
                  "/embed/" +
                  BASE_URL.path.realisasi_target_penerimaan +
                  '"></iframe>'
                }
...
export default RealisasiTargetPenerimaan;
