...
const AlokasiAnggaran = () => {
  ...
  const title = "anggaran vs alokasi anggaran";
  const handlePrint = () => {
    history.push({
      pathname: "/PrintData",
      state: {
        ...
        <div className={classes.paper}>
            ...
            >
              <CopyToClipboard
                text={
                  ...
                  BASE_URL.domain +
                  "/embed/" +
                  BASE_URL.path.alokasi_anggaran +
                  '"></iframe>'
                }
          ...
          >
            <iframe
              width={iframeWidth}
              height={iframeHeight}
              src={BASE_URL.domain + "/embed/" + BASE_URL.path.alokasi_anggaran}
            ></iframe>
          </Grid>
        </div>
      </Modal>
          ...
          >
            ...
            <TooltipMI title="Lihat Detail" placement="top">
              <IconButton
                ...
                onClick={() =>
                  handleOpen({
                    title: "anggaran vs alokasi anggaran",
                    grafik: data,
                    dataTable: "",
                    analisis:
...
export default AlokasiAnggaran;
