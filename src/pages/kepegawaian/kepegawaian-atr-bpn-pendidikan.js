...
const KepegawaianBpnPendidikan = () => {
  ...
  const getData = () => {
    ...
    axios
      .get(
        `${url}Kepegawaian/Pegawai/sie_pegawai_atr_bpn_pendidikan?tahunAwal=${tahunAwal}&tahunAkhir=${years}&kantor=&kanwil=&satker=`
      )
          ...
          >
            <TooltipMI title="Lihat Detail" placement="top">
              <IconButton
                ...
                onClick={() =>
                  handleOpen({
                    title: "Jumlah Pegawai berdasarkan Pendidikan ",
                    grafik: data,
                    dataTable: "",
                    analisis:
...
export default KepegawaianBpnPendidikan;
