...
const KepegawaianBpnJK = () => {
  ...
  const getData = () => {
    ...
    axios
      .post(
        `${url}Kepegawaian/Pegawai/sie_pegawai_atr_bpn_jns_kelamin?tahunAwal=${tahunAwal}&tahunAkhir=${years}`,
        temp
      )
      ...
      <div className={classes.barChart}>
        <ResponsiveContainer width="100%" height={250}>
          ...
          >
            ...
            <XAxis dataKey="jeniskelamin"></XAxis>
            ...
            <Legend />
            <Bar dataKey="jumlah" fill="#66CDAA" name="Jumlah Pegawai" />
          </BarChart>
        </ResponsiveContainer>
      </div>
...
export default KepegawaianBpnJK;
