...
const KepegawaianBpnJabatan = () => {
  ...
  const getData = () => {
    ...
    axios
      .post(
        `${url}Kepegawaian/Pegawai/sie_pegawai_atr_bpn_jabatan?tahunAwal=${tahunAwal}&tahunAkhir=${years}&kantor=${kantor}`,
        temp
      )
      .then(function (response) {
            ...
            >
              ...
              <TableBody>
                {dataModal.grafik
                  ...
                  .map((row) => (
                    <StyledTableRow key={row.jabatan}>
                      <StyledTableCell
                        align="center"
                        component="th"
                        scope="row"
            ...
            >
              <CopyToClipboard
                text={
                  ...
                  BASE_URL.domain +
                  "/embed/" +
                  BASE_URL.path.kepegawaian_bpn_jabatan +
                  '"></iframe>'
                }
