...
const realisasiPenggunaan = () => {
  ...
  const getData = () => {
    ...
    axios
      .post(
        `${url}ProgramStrategisNasional/PTSL/sie_psn_nilai_pnbp?tahunAwal=${tahunAwal}&tahunAkhir=${years}`,
        temp
      )
      .then(function (response) {
        ...
        <div className={classes.paper}>
            ...
            >
              <CopyToClipboard
                text={
                  ...
                  BASE_URL.domain +
                  "/embed/" +
                  BASE_URL.path.sie_psn_nilai_pnbp +
                  '"></iframe>'
                }
          ...
          >
            <iframe
              ...
              height={iframeHeight}
              src={
                BASE_URL.domain + "/embed/" + BASE_URL.path.sie_psn_nilai_pnbp
              }
            ></iframe>
          </Grid>
        </div>
