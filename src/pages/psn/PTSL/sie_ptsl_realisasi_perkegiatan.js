...
const RealisasiPerkegiatan = () => {
  ...
  const getData = () => {
    ...
    axios
      .get(
        `${url}ProgramStrategisNasional/PTSL/sie_ptsl_realisasi_perkegiatan?tahunAwal=${tahunAwal}&tahunAkhir=${years}`
      )
  ...
  const exportData = () => {
    fileExport(
      ...
      "Nilai Jumlah dan luas PTSL per jenis",
      data,
      ".xlsx"
    );
  };
  ...
  const grafik = (
    <ResponsiveContainer width="100%" height={250}>
      ...
      >
        ...
        <Legend />
        <Bar dataKey="kegiatan" fill="#8884d8" />
        ...
        >
          <Grid item xs={6}>
            <Typography className={classes.titleSection} variant="h2">
              Jumlah dan luas PTSL per jenis
            </Typography>
          </Grid>
          <Grid
            container
            ...
            >
              ...
              <TooltipMI title="Lihat Detail" placement="top">
                <IconButton
                  ...
                  onClick={() =>
                    handleOpen({
                      title: "Jumlah dan luas PTSL per jenis",
                      grafik: data,
                      dataTable: "",
                      analisis:
              ...
              <TooltipMI
                ...
                placement="top"
                onClick={() =>
                  handlePrintData("Jumlah dan luas PTSL per jenis", columnTable)
                }
              >
...
export default RealisasiPerkegiatan;
