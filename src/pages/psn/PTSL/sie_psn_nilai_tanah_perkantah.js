...
const realisasiPenggunaan = () => {
  ...
  const getData = () => {
    ...
    axios
      .post(
        `${url}ProgramStrategisNasional/PTSL/sie_psn_nilai_tanah_per_kantah?tahunAwal=${tahunAwal}&tahunAkhir=${years}`,
        temp
      )
      .then(function (response) {
  ...
  let axis = {
    xAxis: "label",
    yAxis: "Nilai Tanah per Kantah",
  };
  const title = " PSN Nilai Tanah per Kantah BPHTB";
  const handlePrint = () => {
    history.push({
      pathname: "/PrintData",
      state: {
            ...
            >
              <CopyToClipboard
                text={
                  ...
                  BASE_URL.domain +
                  "/embed/" +
                  BASE_URL.path.sie_psn_nilai_tanah_per_kantah +
                  '"></iframe>'
                }
            ...
            >
              ...
              <TooltipMI title="Lihat Detail" placement="top">
                <IconButton
                  ...
                  onClick={() =>
                    handleOpen({
                      title: "PSN Nilai Tanah per Kantah",
                      grafik: data,
                      dataTable: "",
                      analisis:
                        comment && comment.lastComment
                          ...
                          : "",
                      type: "Bar",
                      nameColumn: ["Kanwil", "Nilai Tanah per Kantah"],
